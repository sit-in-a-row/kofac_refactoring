...
function sendMessage() {
    ...
    userMessageDiv.className = 'user-message showChat';
    ...
    setTimeout(() => {
        ...
        botMessageDiv.className = 'bot-message fadeIn';
        botMessageDiv.innerHTML = `
            <div class="bot-message-container">
                <div class="bot-message-icon">급</div>
                <div>
                    <div class="bot-message-name">급식봇</div>
                    <!-- 응답 div는 여기에 나중에 추가될 것입니다 -->
                </div>
            </div>
        `;
        chatbox.appendChild(botMessageDiv);

        // 지연 후 bot-message-response 추가
        setTimeout(() => {
            const botResponseDiv = document.createElement('div');
            botResponseDiv.className = 'bot-message-response showChat';
            botResponseDiv.textContent = botResponse;

            // botMessageDiv 내부의 마지막 div에 botResponseDiv 추가
            botMessageDiv.querySelector('.bot-message-container > div > div').appendChild(botResponseDiv);
